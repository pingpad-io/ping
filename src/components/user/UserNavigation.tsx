...
export const UserNavigation = ({ handle }: { handle: string }) => {
  return (
    <nav className="sticky top-3 bg-background/50 backdrop-blur-lg border border-muted rounded-xl z-[40] flex flex-row justify-start items-center gap-2 p-1 mt-2">
