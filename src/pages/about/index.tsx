        ...
        <div className="flex flex-col items-center p-2 sm:p-4 md:p-20 text-center gap-8">
          ...
          <div className="flex flex-col gap-8 p-2 md:p-8">
            <Card>
              ...
              <CardContent>
                this project is an attempt to provide a better microblogging experience -{" "}
            ...
            <Card>
              ...
              <CardContent>
                providing a place to hold discussions <b>without being instrumental</b>, made <b>for you </b> and{" "}
                <b>your community</b>
              </CardContent>
            </Card>
            <Card>
