			...
			<PageLayout>
				<div className="prose p-8 lg:prose-lg">
					...
					<p>
						...
						ping.kualta.dev (the "Service"). This page informs you of our
					...
					<p>
						...
						limited to your email address, name, username, and profile picture.
						We collect this information from the provider you choose when you
						sign up for the Service. We do not use this information for
						marketing purposes, and we do not share this information with any
						third parties.
					</p>
					<h4>Log Data</h4>
					<p>
						...
						party services such as Vercel Analytics that collect, monitor and
						analyze this type of information in order to increase our Service's
					...
					<p>
						...
						use encryption to protect your data. However, no method of
					...
					<p>
						This Privacy Policy is effective as of May 15th, 2023 and will
