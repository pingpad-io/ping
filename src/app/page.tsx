      ...
      <div className="w-full">
        ...
        <div className="grid md:grid-cols-2 px-auto grow items-center justify-center py-10 mt-16 text-3xl p-8 text-center drop-shadow-md dark:drop-shadow-glow place-items-center flex flex-col gap-6 justify-center">
          <div className="col-span-1 flex flex-col gap-2">
            <FadeIn className="duration-500 delay-100">
              <h1>
                a <b>better </b> decentralized social,
              </h1>
            </FadeIn>
            <FadeIn className="duration-500 delay-300">
              <h1>
                staying <b>out of the way</b>
              </h1>
            </FadeIn>
            <FadeIn className="duration-500 delay-500">
              <h1>
                to reach <b>your</b> people
              </h1>
            </FadeIn>
          </div>
          <FadeIn className="duration-500 delay-1000">
        ...
        <FadeIn className="duration-1000 delay-[1500ms]">
        ...
        <FadeIn className="duration-1000 delay-[2000ms]">
        ...
        <FadeIn className="duration-1000">
